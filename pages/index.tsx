  ...
  return <Container>
    <Section>
      ...
      <Text size='xl' opacity={80}>
        I'm a young person at an unspecified age. I've worked with TypeScript, Go, Rust, React, Vue, Svelte, etc in the past. Currently learning Haskell and functional programming. Working at <Link variant='loud' target='_blank' href="https://transloadit.com">Transloadit</Link>
      </Text>
      <Spacer size={2} />
      <Stack gap={8}>
        <Button bg='accent'>Get in touch</Button>
      </Stack>
    </Section>
    <Spacer size={16}/> 
    <Section>
